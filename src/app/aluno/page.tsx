...
export default function AlunoDashboardPage() {
  ...
  // Mostra um estado de carregamento simples enquanto o Better Auth busca os dados do usuário
  if (isPending) {
    return (
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white shadow-lg shadow-blue-900/20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white text-blue-700 font-bold px-6 py-3 rounded-lg hover:bg-blue-50 hover:scale-105 transition-all shadow-md"
            >
